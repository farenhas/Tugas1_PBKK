       ...
       <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
           ...
           @forelse ($posts as $post)
                   ...
                   <div class="flex justify-between items-center">
                     <a href="/posts?author={{ $post->author->username }}">
                       <div class="flex items-center space-x-3">
                           <img class="w-7 h-7 rounded-full" src="{{ $post->author->avatar_url }}" alt="{{ $post->author->name }} avatar" /> <!-- Misalnya, jika Anda punya avatar -->
               ...
               <div class="flex flex-col items-center justify-center py-10">
                  <p class="font-semibold text-2xl text-gray-800 dark:text-gray-100 my-4">
                      Article Not Found
                  </p>
                  <a href="/posts" class="text-blue-600 hover:text-blue-800 font-medium hover:underline text-lg transition-all duration-300">
